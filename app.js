...
const projects = [
  ...
  },
  {
    ...
    tech: 'css',
    week: 4,
    desc: 'Made the portfolio responsive using mobile-first design, media queries, responsive images, and fluid typography with clamp().',
    link: 'https://masuma-t.github.io/hello-web/'
  },
  {
...
function getFilteredProjects() {
  ...
  return projects.filter(p => {
    const matchesTech =
      activeTech === 'all' || p.tech === activeTech;
